  ...
  <nav class=" b-navbar navbar-expand-lg ">
    <div class="nav__wrapper b-container-fluid">
      <a class="b-navbar-brand shadow-large d-flex flex-wrap" href="#">
        <h1 class="logo mr-1 text-center b-container" data-toggle="tooltip" data-placement="top" title="A long time ago in a galaxy far, far away....">Galactic Translator</h1>
      </a>
              <!-- hamburger display based on media query also bound to isActive truthy class -->
        <button class="hamburger b-navbar-toggle" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" @click="myFilter" v-bind:class="{active: isActive}">Menu
      ...
      <div class="b-collapse navbar-collapse" id="navbarsExample05">
        <!-- router-link to nav for each main app vue -->
        <ul class="nav-menu b-navbar-nav mx-auto" :class="{active: isActive}" id="js-menu">
          <li class="b-nav-item mr-3 active">
            <router-link to="/" class="nav-link">Home</router-link>
          </li>
          <li class="b-nav-item mr-3 dropdown">
            <router-link to="/translatorapp" class="nav-link" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Translator</router-link>
          </li>
          <li class="b-nav-item mr-3">
...
.b-navbar-brand {
    ...
    font-family: 'Galaxy';
    transition: text-shadow 1s ease, color 2s ease, font-weight 2s ease, opacity 2s ease;
}
...
/* For future additional language translations
    div > .dropdown-item {
    color: #000;
    font-size: 1.5rem;
    font-weight: 900;
...
.b-navbar-toggle {
    ...
    border-radius: 10px;
    box-shadow: -1px -1px 3px 1px #482ff7;
}
.b-navbar-toggle .navbar-toggler-icon {
        color: #0000c9;
        width: auto;
}
.hamburger {
